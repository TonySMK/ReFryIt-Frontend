...
import PageSettingModal from "../../components_modals/PageSettingModal/PageSettingModal";
...
export default function Header() {
  ...
  function closeSetingsModalHandler() {
    setIsSettingsModelOpen(false);
  }
  ...
  return (
    <header className="mainheader">
      ...
      <PageSettingModal
        ...
        closeSetingsModalHandler={closeSetingsModalHandler}
      />
    </header>
  );
}
